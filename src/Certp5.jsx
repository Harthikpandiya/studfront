...
//     // 🖼️ Update image preview
//     if (response.data.image) {
//       setPreviewUrl(`http://localhost:5000/uploads/${response.data.image}`);
//     }
//     else{
//         setPreviewUrl(`http://localhost:5000/uploads/${response.data. filePath}`);
//     }
...
//                   {formData.file && <><p>{formData.file.name}</p><img src={URL.createObjectURL(formData.file)} alt="Preview" style={{ width: '120px', marginTop: '10px', borderRadius: '10px' }} /></>}
//                   {imageName && <p>📂 Image in DB: {imageName}</p>}
//                 </div>
//               </div>
...
//                     <p style={{ textAlign: 'center' }}><strong>{formData.file ? "Uploaded Image:" : "Existing Image:"}</strong></p>
//                     {/* <img
//                       src={formData.file ? URL.createObjectURL(formData.file) : `http://localhost:5000/${formData.filePath}`}
//                       alt="Preview"
//                       style={{ width: '138px', height: '177px', borderRadius: '10px' }}
//                     /> */}

//                     {/* <img
//   src={previewUrl || `http://localhost:5000/uploads/${formData.imageFilename}`}
//   alt="Preview"
//   width="100"
// /> */}
...
//   <img
//     src={previewUrl || `http://localhost:5000/uploads/${formData.filePath}`}
//     alt="Preview"
//     width="120"
//   />
// </div>
...
//                   { label: "Date", value: formData.date }
//                 ].map((item, idx) => (
//                   <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 14px', backgroundColor: '#f5f5f5', borderRadius: '6px', border: '1px solid #ddd' }}>
//                     <span style={{ fontWeight: '600', width: '40%' }}>{item.label}</span>
//                     <span style={{ width: '60%', textAlign: 'right' }}>{item.value}</span>
//                   </div>
//                 ))}
