...
//     try {
//       const response = await axios.get(`http://localhost:5000/api/courses?q=${value}`);
...
//       fetchCourseSuggestions(e.target.value); // ✅ Now this will work
//     }
//   };
...
//           key={index}
//           onClick={() => {
//             setFormData(prev => ({ ...prev, courseCode: item }));
//             setCourseSuggestions([]);
//           }}
...
//                   <img src="upload.png" alt="Upload" onClick={handleImageClick} style={{ width: '60px', height: '60px', cursor: 'pointer' }} />
//                   {formData.file && (
//                     <>
//                       <p style={{ fontSize: '14px' }}>{formData.file.name}</p>
//                       <img src={previewUrl} alt="Preview" style={{ width: '120px', marginTop: '10px', borderRadius: '10px' }} />
//                     </>
//                   )}
//                   {imageName && (
//                     <p style={{ fontStyle: 'italic', fontSize: '14px', marginTop: '8px', color: 'gray' }}>📂 Image in DB: {imageName}</p>
//                   )}
//                 </div>
//               </div>
//               <div className="form-row button-row" style={{ marginTop: '20px', display: 'flex', justifyContent: 'center', gap: '10px' }}>
//                 <button onClick={() => setStep(1)} className="btn">Preview</button>
//                 {mode === 'update' ? (
//                   <button onClick={confirmUpdate} className="btn">Confirm Update</button>
//                 ) : (
...
//                     <img src={previewUrl} alt="Preview" style={{ width: '138px', height: '177px', borderRadius: '10px' }} />
//                   </div>
//                 </div>
//               )}
//               <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '18px', color: '#4a4a4a', marginBottom: '15px' }}>
//                 Certificate No: {certificateNumber}
//               </div>
//               <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
//                 {[{ label: "Certificate No", value: certificateNumber }, { label: "Full Name", value: formData.fullName }, { label: "Reg. No", value: formData.regNo }, { label: "Email", value: formData.email }, { label: "Whatsapp Number", value: formData.whatsappNumber }, { label: "Branch", value: formData.branch }, { label: "Course & Code", value: formData.courseCode }, { label: "Trainer Name", value: formData.trainerName }, { label: "Date", value: formData.date }].map((item, idx) => (
//                   <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 14px', backgroundColor: '#f5f5f5', borderRadius: '6px', border: '1px solid #ddd' }}>
...
//     <button onClick={handleSubmit} className="btn">Confirm & Submit</button>
//   )}
//   <button onClick={handleDelete} className="btn" style={{ backgroundColor: '#e74c3c' }}>🗑 Delete</button>
// </div>
//             </div>
//           );
//         })()}
