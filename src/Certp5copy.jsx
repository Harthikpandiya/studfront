...
//   const [mode, setMode] = useState(''); // 'submit' or 'update'
...
// const goToPreview = (e) => {
//   e.preventDefault();
//   if (!mode) setMode('submit');  // ✅ default mode when user is submitting
//   setStep(2);
// };
...
//             <img
//                src={`http://localhost:5000/uploads/${formData.filePath}`}
//               alt="Preview"
